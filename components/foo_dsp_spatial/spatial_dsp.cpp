...
spatial_upmix_dsp::spatial_upmix_dsp(const dsp_preset&)
    : config_(ReadDspConfig()) {}
...
void spatial_upmix_dsp::g_show_config_popup(const dsp_preset&, HWND parent, dsp_preset_edit_callback&) {
    dsp_config_popup popup;
